...
const PHILOSOPHY = [
  "이해하기 쉽고 유지보수 가능한 코드를 작성하기",
  "협업 과정에서 적극적으로 소통하며 팀과 함께 성장하기",
...
export default function AboutMe() {
  return (
    <div className={styles.about_grid}>
      ...
      <section className={styles.card}>
        <p className={styles.card_title}>개발 철학</p>
        <ul className={styles.philosophy_list}>
          {PHILOSOPHY.map((item) => (
            <li key={item}>{item}</li>
          ))}
        </ul>
      ...
      <section className={`${styles.card} ${styles.card_wide}`}>
        <p className={styles.card_title}>Skills</p>
